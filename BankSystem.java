...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	//	author = new JLabel (" " + "Bank Of Patel", Label.LEFT);
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			String msg = "Bank Of Patel\n\n" + "Created & Designed By:\n" + 
				"Patel Group\n\n" + "E-mail me:\n harshilpatel98258@gmail.com";
